"""
Auto-generated by the TensorScript transpiler from `optimize BaseLM as SFTStage`.
...
OUTPUT_DIR = os.environ.get("TENSORSCRIPT_OUTPUT_DIR", "./output/SFTStage")
...
# ---- dataset ----
raw_dataset = load_dataset("HuggingFaceH4/ultrachat_200k", split='train', token=None)
_split = raw_dataset.train_test_split(train_size=0.95)
...
# ---- model ----
_base_path = "meta-llama/Meta-Llama-3-8B"
